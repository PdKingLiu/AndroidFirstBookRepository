...
public class NewsTitleFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        RecyclerView newsTitleRectclerView = (RecyclerView) view.findViewById(R.id.news_title_recycler_view);
        LinearLayoutManager layoutManager = new LinearLayoutManager(getActivity());
        newsTitleRectclerView.setLayoutManager(layoutManager);
        NewsAdapter adapter = new NewsAdapter(getNews());
        newsTitleRectclerView.setAdapter(adapter);
        return view;
    }
    ...
    class NewsAdapter extends RecyclerView.Adapter<NewsAdapter.ViewHolder> {
        ...
        public NewsAdapter(List<News> mNewList) {
